...
//    DEBUG_PRINT("ObstacleMap::create(): bounds (%g,%g)->(%g,%g), dims(%i,%i)\n",
...
//    } // end for i
//    //cv::imshow("ObstacleMap", _map_as_img); cv::waitKey(500);
//    inflate();
//    return true;
//  }
...
//  bool inflate() {
//    if (_map_as_img.empty()) {
//      printf("ObstacleMap::inflate(): empty map!\n");
//      return false;
//    }
...
//    //cv::imshow("ObstacleMap-inflated", _map_as_img); cv::waitKey(500);
//    return true;
//  }
